...
class MySQLConnectionPool(object):
    ...
    """
    # max_pool_size=30,auto_resize_scale=1.5,pool_resize_boundary=48,
    def __init__(self, pool_name="default_pool", host=None, user=None, password="", database=None, port=3306,
                 charset='utf8', use_dict_cursor=True, max_pool_size=30,
                 enable_auto_resize=False, auto_resize_scale=1.5,
        ...
        :param kwargs: unknown keyword arguments to be passed to `pymysql.Connection`
        """
